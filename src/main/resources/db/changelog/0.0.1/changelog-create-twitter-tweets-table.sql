...
--changeset ValeryBezborodov:create-twitter-tweets-table
...
--changeset ValeryBezborodov:add-twitter-tweets-table-constraints
...
--changeset ValeryBezborodov:add-twitter-tweets-table-column-modified_timestamp
