...
--changeset ValeryBezborodov:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset ValeryBezborodov:create-identity-user_accounts-table
...
--changeset ValeryBezborodov:create-identity-user_roles-table
...
--changeset ValeryBezborodov:create-identity-user_accounts_roles-table
...
--changeset ValeryBezborodov:add-user_accounts_roles-table-constraints
...
--changeset ValeryBezborodov:add-data-to-user_roles-table
